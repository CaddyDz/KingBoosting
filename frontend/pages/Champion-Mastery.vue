<template>
	<div>
		<div
			class="slider"
			fluid
			:style="{background: 'url(/img/services/champion-mastery-top-bg.png) top/cover'}"
		>
			<v-row justify="center" align="center">
				<v-col md="8" style="text-align: center;">
					<p>Champion Mastery</p>
					<br />Want to look good with all of your champions independently? Champion mastery boost is here to get any of your champions to tier 7 from 0 at no time.
				</v-col>
			</v-row>
