<template>
	<div>
		<div
			class="slider"
			fluid
			:style="{background: 'url(/img/services/clash-boosting-top-bg.png) top/cover'}"
		>
			<v-row justify="center" align="center">
				<v-col md="8" style="text-align: center;">
					<p>Clash Boosting</p>
					<br />Start winning your Clash games! Hire Challenger players to boost your team's performance in LoL Clashes.
				</v-col>
			</v-row>
